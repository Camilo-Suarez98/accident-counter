...
const Counter = () => {
  ...
  const [valueToAdd, setValueToAdd] = useState<number>(count);
    ...
    <section className="flex flex-col items-center w-2/3 gap-8 p-8 bg-white border-4 shadow-lg border-primary-500">
      ...
      <div>
        <form onSubmit={(e) => {
          ...
          <input type="number" value={valueToAdd} onChange={(e) => dispatch({ type: 'updateDraftCount', payload: e.target.value })} />
